...
<html>
<head>
<title>SIA CONTABILIDAD PRESUPUESTARIA (Detalles Incluir C&oacute;digos del Pago)</title>
 ...
 <table width="845" border="0" cellspacing="0" cellpadding="0">
    <tr height="10">
      <td><table width="840" border="0" align="left">
        <tr>
          <td width="222" align="center" valign="middle"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar C&oacute;digo al Pago" onclick="javascript:LlamarURL('Inc_codigo_pago.php?codigo_mov=<?echo $codigo_mov?>')"></td>
