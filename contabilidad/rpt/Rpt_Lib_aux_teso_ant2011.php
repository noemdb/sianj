<?include ("../../class/fun_fechas.php"); include ("../../class/fun_numeros.php");include ("../../class/configura.inc");include ("../../class/conect.php"); error_reporting(E_ALL ^ E_NOTICE); $php_os=PHP_OS;
 $periodo=$_GET["periodo"];  $cod_cuenta_d=$_GET["cod_cuenta_d"]; $cod_cuenta_h=$_GET["cod_cuenta_h"]; 
  ...
  while($registro=pg_fetch_array($resultado)){ 
      if($c==0){$c=1; $prev_cuenta=$registro["cod_cuenta"]; $prev_fecha=$registro["fecha"]; $prev_deb_cre=$registro["debito_credito"];   }       
	   ...
	   If(substr($cod_cuenta,0,10)=="1-1-102-02" ){  $gcolumna1=$gcolumna1+$monto_asiento; $mcuenta_g=substr($cod_cuenta,0,10);}
			   ...
			   If(substr($cod_cuenta,0,7)=="1-1-132" ){  $mdes4="FONDOS DE TRECEROS"; $mnombre_g=$mdes4;}
    ...
    $sSQL="SELECT * from CON013 Where (tipo_registro='6') And (nombre_usuario='$usuario_sia') order by  fecha,aoperacion";	$res=pg_query($sSQL); 
	  ...
	  class PDF extends FPDF{
		function Header(){ global $criterio1; 
			...
			$this->Cell(40);
			$this->Cell(300,10,'LIBRO AUXILIAR DEL MOVIMIENTO DE TESORERIA',1,0,'C');
			$this->Ln(10);
		...
		function Footer(){global $fin_rpt; global $tcol1_d; global $tcol1_c; global $tcol2_d; global $tcol2_c; global $tcol3_d; global $tcol3_c;
			...
			if($fin_rpt==1){$this->Line(10,200,350,200); $this->SetY(-14);
			   $tcol1_d=formato_monto($tcol1_d); $tcol2_d=formato_monto($tcol2_d); $tcol3_d=formato_monto($tcol3_d); $tcol4_d=formato_monto($tcol4_d);			   
			   $tcol5_d=formato_monto($tcol5_d); $tcol6_d=formato_monto($tcol6_d); $tcol7_d=formato_monto($tcol7_d); 
			   $tcol1_c=formato_monto($tcol1_c); $tcol2_c=formato_monto($tcol2_c); $tcol3_c=formato_monto($tcol3_c); $tcol4_c=formato_monto($tcol4_c);			   
			   $tcol5_c=formato_monto($tcol5_c); $tcol6_c=formato_monto($tcol6_c); $tcol7_c=formato_monto($tcol7_c);
			   
			   $this->SetFont('Arial','B',6);
			   $this->Cell(76,3,'',0,0);
			   $this->Cell(16,3,'',0,0,'R');			   
			   $this->Cell(17,3,$tcol1_d,0,0,'R');
			   $this->Cell(17,3,$tcol1_c,0,0,'R');
			   $this->Cell(17,3,$tcol2_d,0,0,'R');
			   $this->Cell(17,3,$tcol2_c,0,0,'R');
			   $this->Cell(17,3,$tcol3_d,0,0,'R');
			   $this->Cell(17,3,$tcol3_c,0,0,'R');
			   $this->Cell(17,3,$tcol4_d,0,0,'R');
			   $this->Cell(17,3,$tcol4_c,0,0,'R');
			   $this->Cell(17,3,$tcol5_d,0,0,'R');
			   $this->Cell(17,3,$tcol5_c,0,0,'R');
			   $this->Cell(17,3,$tcol6_d,0,0,'R');
			   $this->Cell(17,3,$tcol6_c,0,0,'R');			   
			   $this->Cell(5,3,'',0,0,'R');
			   $this->Cell(17,3,$tcol7_d,0,0,'R');
			   $this->Cell(17,3,$tcol7_c,0,0,'R');
			   $this->Cell(5,3,'',0,1,'R');
			}else{$this->SetY(-10);}
	  ...
	  $i=0;  $n_asiento=0; $prev_fecha=""; $prev_operacion=""; $t_monto=0; $prev_cod1="";  $prev_cod2="";
	  ...
	  while($registro=pg_fetch_array($res)){ $i=$i+1; $codigo_cuenta=$registro["codigo_cuenta"];    $nombre_cuenta=$registro["nombre_cuenta"]; $fecha=$registro["fecha"];
		   ...
		   if($prev_fecha<>$fecha){ 
			 ...
			 $n_asiento=$n_asiento+1; $prev_fecha=$fecha; $t_monto=0; $prev_cod1=""; $prev_cod2="";
			 $gcolumna1_d=0;  $gcolumna2_d=0;  $gcolumna3_d=0; $gcolumna4_d=0; $gcolumna5_d=0;  $gcolumna6_d=0; $gcolumna7_d=0; $gcolumna8_d=0; $gcolumna9_d=0;
	         $gcolumna1_c=0;  $gcolumna2_c=0;  $gcolumna3_c=0; $gcolumna4_c=0; $gcolumna5_c=0;  $gcolumna6_c=0; $gcolumna7_c=0; $gcolumna8_c=0; $gcolumna9_c=0;
		   ...
		   $montod=formato_monto($columna10); if($debito_credito=='D'){$t_monto=$t_monto+$columna10;}
