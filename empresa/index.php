  ...
  <table width="350" height="328" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#0000CC">
    <tr>
      <td>
         ...
         <tr>
           <td align="center"><span class="Estilo6 Estilo4 Estilo2 Estilo5"><strong>CONFIGURACI&Oacute;N Y MANTENIMIENTO</strong></span></td>
         </tr>
       </table>
        ...
        <tr>
          <td height="110"><table width="305" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td><input name="txtusuario" type="text" id="txtusuario" onFocus="encender(this); " onBlur="apagar(this);"></td>
            </tr>
            <tr>
              <td><pre class="Estilo4">CONTRASE&Ntilde;A : </pre></td>
              <td><input name="txtclave" type="password" id="txtclave" onFocus="encender(this); " onBlur="apagar(this);"></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="48">            <table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center"><input type="submit" name="Aceptar" value="Aceptar"></td>
              </tr>
            </table></td>
        </tr>
      </table>
