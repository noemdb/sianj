...
while($registro=pg_fetch_array($res)){ $cod_articulo=$registro["cod_articulo"]; $nro_linea=$registro["nro_linea"]; $cantidad=$registro["cant_requerida"]; 
 $cant_ajustada=$registro["cant_ajustada"]; $cant_recibida=$registro["cant_recibida"]; $cant_devuelta=$registro["cant_devuelta"]; $por_recibir=$cantidad-$cant_recibida;
