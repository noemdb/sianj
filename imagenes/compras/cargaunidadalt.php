...
$conn=pg_connect("host=localhost port=5432 password=".$password." user=".$user." dbname=".$dbname.""); $StrSQL="select * from comp024 order by des_unidad_medida";  $res=pg_query($StrSQL);
?><select name="txtunidad_alterna" id="txtunidad_alterna" onFocus="encender(this)" onBlur="apagar(this);">  <?
