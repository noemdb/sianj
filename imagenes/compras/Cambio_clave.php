...
<html>
<head>
<title>SIA CONTABILIDAD PRESUPUESTARIA  (Cambio de Clave)</title>
        ...
        <tr>
          <td><table width="520">
            <tr>
              ...
              <td width="300"><input name="txtnombre_usuario" type="text"  id="txtnombre_usuario" size="20" maxlength="20" readonly value="<? echo $usuario_sia ?>"></td>
               </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
