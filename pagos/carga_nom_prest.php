<?include ("../class/conect.php");  include ("../class/funciones.php"); 
   ...
   if (!$conn) { echo "<p><b>Ocurrio un error conectando a la base de datos: .</b></p>"; exit; }
    $codigo_mov="00000005";  $cod_pre_ret="";
   ...
   $path="prest.txt"; $fp = fopen($path,"r");
   while ($linea= fgets($fp,1024)) {
      ...
      if(($tipo=="1")and($error==0)){  $monto=cambia_coma_numero($monto); $cod_partida=substr($codigo,0,3)."-".substr($codigo,3,2)."-".substr($codigo,5,2) ."-".substr($codigo,7,2);
