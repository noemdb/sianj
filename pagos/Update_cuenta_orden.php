...
$cod_cuenta=$_POST["txtCodigo_Cuenta"];$codigo_mov=$_POST["txtcodigo_mov"];$debito_credito=$_POST["txtDeb_Cre"];
...
pg_close();
?> <script language="JavaScript">document.location ='Det_inc_comp_ord_fin.php?codigo_mov=<?echo $codigo_mov?>';</script>