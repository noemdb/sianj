<?include ("../class/funciones.php"); 
  //cod_presup_est='01-00-51-401-05-01-00'
   ...
   if (!$conn) { echo "<p><b>Ocurrio un error conectando a la base de datos: .</b></p>"; exit; }
    $codigo_mov="00000008";  $cod_pre_ret="";
   ...
   $path="bonofa.txt"; $fp = fopen($path,"r");
   while ($linea= fgets($fp,1024)) {
      ...
      if((($tipo=="1")or(($tipo=="2")and(substr($codigo,0,1)=="4")))and($error==0)){
  	    $monto=elimina_puntos($monto);  $monto=cambia_coma_numero($monto);
