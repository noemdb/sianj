...
$tipo_retencion=$_GET["tipo_ret"];$referencia_comp=$_GET["referencia"];$tipo_compromiso=$_GET["tipo"];$cod_presup=$_GET["codigo"];$fuente_financ=$_GET["fuente"];$codigo_mov=$_GET["codigo_mov"];
$url="Det_inc_ret_est.php?codigo_mov=".$codigo_mov;echo "ESPERE POR FAVOR ELIMINANDO....","<br>";$error=0;
...
if (pg_ErrorMessage($conn)) { ?> <script language="JavaScript">   muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');  </script> <?}
  ...
  if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('RETENCION NO EXISTE EN LA ESTRUCTURA');</script> <? }
