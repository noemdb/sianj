...
$url="Det_inc_comp_ord_fin.php?codigo_mov=".$codigo_mov; echo "ESPERE POR FAVOR INCLUYENDO....","<br>";
...
if (pg_ErrorMessage($conn)){ ?><script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script><?}
      ...
      if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('CÓDIGO DE CUENTA NO EXISTE');</script><? }
        ...
        if ($registro["cargable"]=="N"){$error=1; ?> <script language="JavaScript"> muestra('CÓDIGO DE CUENTA NO ES CARGABLE');</script><?}
      }
