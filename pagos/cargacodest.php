...
$StrSQL="select * from pre026 where codigo_mov='$codigo_mov' and monto>0 order by tipo_compromiso,referencia_comp,cod_presup,fuente_financ"; $res=pg_query($StrSQL);
