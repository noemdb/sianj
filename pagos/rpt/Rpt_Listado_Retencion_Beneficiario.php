                    ...
                    <tr>
                      <td height="19" align="center" class="Estilo5"><table width="781" border="0">
                          <tr>
							...
							<td width="202"><span class="Estilo5"><input class="Estilo10" name="txttipo_planilla_ret_d" type="text" id="txttipo_planilla_ret_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $tipo_planilla_d?>" size="4" maxlength="2" class="Estilo5"></span> </td>
                            <td width="10">&nbsp;</td>
                            <td width="362"><span class="Estilo5"><input class="Estilo10" name="txttipo_planilla_ret_h" type="text" id="txttipo_planilla_ret_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $tipo_planilla_h?>" size="4" maxlength="2" class="Estilo5"></span></td>
                          </tr>
                      </table></td>
                    </tr>
                    <tr>
