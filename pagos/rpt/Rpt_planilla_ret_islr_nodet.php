...
$direccion_emp=""; $nombre_emp=""; $ced_rif_emp="";$sql="Select * from SIA000 order by campo001"; $resultado=pg_query($sql);
if ($registro=pg_fetch_array($resultado,0)){$cod_emp=$registro["campo001"]; $direccion_emp=$registro["campo006"]; $nombre_emp=$registro["campo004"]; $nom_completo=$registro["campo005"]; $ced_rif_emp=$registro["campo007"]; $nit_emp=$registro["campo008"]; }
$nro_ord=""; $nro_comp=""; $sustraendo=0; $descripcion_ret=""; $fechae=""; $tipo_en=""; $tipo_documento=""; $nro_documento=""; $nro_con_factura=""; $fecha=""; $descripcion=""; $tipo_operacion="A";
...
if ($registro=pg_fetch_array($res)){  
  ...
  $efecha=$registro["fecha_emision"]; $fechae = substr($efecha,8,2)."/".substr($efecha,5,2)."/".substr($efecha,0,4);  $ano_fiscal=substr($efecha,0,4);
...
class PDF extends FPDF{ 
	function Header(){global $nro_comp; global $fecha; global $nombre_emp; global $ced_rif_emp; global $direccion_emp; global $ano_fiscal; global $mes_fiscal; global $direccion; global $nombre_planilla; global $nro_ord; global $monto_pago;
	   ...
	   global $monto_iva; global $monto_sin_iva; global $monto_r; global $tasa_iva; global $clasificacion; global $monto_o; global $tasa; global $descripcion_ret; global $ciudad; global $tipo_documento; global $telefono; global $tipo_en; global $nro_documento;
		...
		$this->Cell(30,5,'G-20009334-0','1',1,'C');	
		$this->Cell(200,5,$direccion_emp,'LRT',1,'L');
		...
		$this->Cell(130,5,$tipo_documento.' '.$nro_documento,'LRT',0,'C');
