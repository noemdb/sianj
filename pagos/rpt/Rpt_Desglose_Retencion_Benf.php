...
<html>
<head>
<title>SIA ORDENAMIENTO DE PAGO (Reporte Relacion Desglose de Retencion por Beneficiario)</title>
        ...
        <tr>
          <td height="19" colspan="3" align="center"  ><table width="776" border="0">
            <tr>
              ...
              <td width="118"><span class="Estilo5"><input class="Estilo10" name="Catalogo1" type="button" id="Catalogo1" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosd.php?criterio=','SIA','','750','500','true')" value="..."></span></td>
        ...
        <tr>
          <td height="19" colspan="3" align="center"  ><table width="776" border="0">
            <tr>
              ...
              <td width="148"><span class="Estilo5"><input class="Estilo10" name="Catalogo3" type="button" id="Catalogo3" title="Abrir Catalogo de Tipo de Retencion" onClick="VentanaCentrada('../Cat_Tipo_Retencionesd.php?criterio=','SIA','','750','500','true')" value="..."></span></td>
              ...
              <td width="286"><span class="Estilo5"><input class="Estilo10" name="Catalogo4" type="button" id="Catalogo4" title="Abrir Catalogo de Tipo de Retencion" onClick="VentanaCentrada('../Cat_Tipo_Retencionesh.php?criterio=','SIA','','750','500','true')" value="..."></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="19" colspan="3" align="center"  ><table width="776" border="0">
            <tr>
              ...
              <td width="231"><span class="Estilo5"><input class="Estilo10" name="txtnro_orden_d" type="text" id="txtnro_orden_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $nro_orden_d?>" onchange="checkreferenciad(this.form)" size="10" maxlength="8" class="Estilo5"> </span></td>
	     <td width="353"><span class="Estilo5"><input class="Estilo10" name="txtnro_orden_h" type="text" id="txtnro_orden_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $nro_orden_h?>" onchange="checkreferenciah(this.form)" size="10" maxlength="8" class="Estilo5"> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
