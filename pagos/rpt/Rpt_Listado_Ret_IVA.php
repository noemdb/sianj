              ...
              <tr>
                    ...
                    <tr>
                      <td height="19" colspan="4"><table width="776" border="0">
                          <tr>
                            ...
                            <td width="174"><span class="Estilo5"> <input class="Estilo10" name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $fecha_d?>" size="12" maxlength="10" onChange="checkrefechad(this.form)" class="Estilo5">
                ...
                onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario2')"  /></span></div></td>
                    ...
                    <tr>
                      ...
                      <td width="180"><span class="Estilo5"><input class="Estilo10" name="txtnum_comprobante_d" type="text" id="txtnum_comprobante_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $comprobante_d?>" size="10" maxlength="8" class="Estilo5"></span></td>
                      <td width="374"><span class="Estilo5"><input class="Estilo10" name="txtnum_comprobante_h" type="text" id="txtnum_comprobante_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $comprobante_h?>" size="10" maxlength="8" class="Estilo5"></span></td>
                    ...
                    <tr>
                      <td height="19" colspan="4"><table width="782" border="0">
                          <tr>
                            ...
                            <td width="97"><span class="Estilo5"><input class="Estilo10" name="txtcedula_d" type="text" id="txtcedula_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $cedula_d?>" size="15" maxlength="12" class="Estilo5"></span></td>
                            <td width="71"><span class="Estilo5"><input class="Estilo10" name="Catalogo1" type="button" id="Catalogo14" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosd.php?criterio=','SIA','','750','500','true')" value="..."></span></td>
                            <td width="106"><span class="Estilo12"><span class="Estilo5"><input class="Estilo10" name="txtcedula_h" type="text" id="txtcedula_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $cedula_h?>" size="12" maxlength="15" class="Estilo5"></span></span></td>
                            <td width="149"><span class="Estilo5"><input class="Estilo10" name="Catalogo2" type="button" id="Catalogo24" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosh.php?criterio=','SIA','','750','500','true')" value="..."></span></td>
