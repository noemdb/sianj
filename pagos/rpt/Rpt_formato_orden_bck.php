<? error_reporting(E_ALL);include ("../../class/conect.php"); include("../../class/fun_fechas.php"); include("../../class/fun_numeros.php"); $php_os=PHP_OS; $php_os="WINNT"; error_reporting(E_ALL ^ E_NOTICE); echo '123';exit;
...
if($filas>0){  $registro=pg_fetch_array($res); $nro_orden=$registro["nro_orden"];   $tipo_causado=$registro["tipo_causado"];
  ...
  $orden_permanen=$registro["orden_permanen"]; if($pago_ces=="S"){ $nombre_ces=$nombre_ces;}else { $nombre_ces=""; $ced_rif_ces="";  }
