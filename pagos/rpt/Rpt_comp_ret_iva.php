...
if ($registro=pg_fetch_array($res,0)){ $cant_tot=$registro["cant_tot"]; }  $cant_tot= $cant_tot*1;  
...
class PDF extends FPDF{ 
    ...
    function Footer(){ global $total_d; global $total_e; global $total_b; global $total_ret; global $total_iva; global $cant_tot; global $cant_fact;
		...
		$this->Cell(30,2,'',0,0,'C');
		$this->Cell(130,2,'_______________________________________',0,0,'C');
		$this->Cell(100,2,'_______________________________________',0,1,'C');
        $this->Cell(30,4,'',0,0,'C');		
		$this->Cell(130,4,'FIRMA AGENTE DE RETENCION',0,0,'C');
		$this->Cell(100,4,'FIRMA PROVEEDOR',0,1,'C');		
		$this->SetFillColor(255,0,0);		
		$this->Ln(3);
		$this->SetFont('Arial','B',6);
		$this->Cell(20,3,'ORIGINAL: ',0,0,'L');
		$this->SetFont('Arial','',6);
		$this->Cell(240,3,'AGENTE DE RETENCIÓN',0,1,'L');
		$this->SetFont('Arial','B',6);
		$this->Cell(20,3,'DUPLICADO: ',0,0,'L');
		$this->SetFont('Arial','',6);
		$this->Cell(240,3,'PROVEEDOR',0,1,'L');
		$this->SetFont('Arial','B',6);
		$this->Cell(20,3,'TRIPLICADO: ',0,0,'L');
		$this->SetFont('Arial','',6);
		$this->Cell(190,3,'ADMINISTRACIÓN',0,0,'L');
  ...
  while(($registro=pg_fetch_array($res))and($error==0)){ $cant_fact=$cant_fact+1;
    ...
    $nro_fact="".$espacio.""; $nro_ndb=""; $nro_ncr="";  if($registro["tipo_documento"]=="01"){$nro_fact=$registro["nro_documento"];} 
    ...
    $pdf->Cell(7,3,$registro["nro_operacion"],0,0,'C');
	$pdf->Cell(17,3,$fecha,0,0,'C');
	$pdf->Cell(25,3,$nro_fact,0,0,'C');
	$pdf->Cell(25,3,$registro["nro_con_documento"],0,0,'C');
	$pdf->Cell(20,3,$nro_ndb,0,0,'C');
	$pdf->Cell(20,3,$nro_ncr,0,0,'C');
	$pdf->Cell(17,3,$registro["tipo_transaccion"],0,0,'C');
	$pdf->Cell(20,3,$nro_fact_af,0,0,'C');
	$pdf->Cell(20,3,$monto,0,0,'R');
	$pdf->Cell(20,3,$montos,0,0,'R');
	$pdf->Cell(20,3,$montob,0,0,'R');	
	$pdf->Cell(6,3,$tasa,0,0,'C');
	$pdf->Cell(20,3,$montoi,0,0,'R');		
	$pdf->Cell(3,3,'',0,0,'C');
	$pdf->Cell(20,3,$montor,0,1,'R'); 
