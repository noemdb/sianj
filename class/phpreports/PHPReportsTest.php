<?php
        ...
        ini_set("include_path",ini_get("")."c:/AppServ/www/phpreports/");
     ...
     // $sSQL = "select tipo_compromiso,nombre_tipo_comp,nombre_abrev_comp from pre002";
        $sUser = "eduardo";        // database user
        $sPass = "123";        // database password
     //   $oRpt->setSQL($sSQL);
        $sData = "SIA";        // database name
        $sInte = "postgresql";        // database interface
