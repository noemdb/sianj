...
<html>
<head>
<title>SIA CONTABILIDAD PRESUPUESTARIA (Catalogo de Creditoa Adicionales)</title>
...
<body>
<?      $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;    $criterio = "where (anulado='N') and (tipo_modif='1')";
