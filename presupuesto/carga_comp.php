...
$dbnamed=$_POST["txtclave_empresa"]; $codigo_mov=$_POST["txtcodigo_mov"]; $referencia_comp=$_POST["txtreferencia_comp"]; $tipo_compromiso=$_POST["txttipo_compromiso"];
$cod_comp="0000"; $error=0; $equipo=getenv("COMPUTERNAME"); echo "ESPERE POR FAVOR BUSCANDO....","<br>";
 ?>
<html>
<head>  <title>CARGAR COMPROMISO</title>
...
$sql="SELECT * FROM codigos_compromisos where referencia_comp='$referencia_comp' and tipo_compromiso='$tipo_compromiso' and cod_comp='$cod_comp' order by cod_presup"; $res=pg_query($connd,$sql);  
