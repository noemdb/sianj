...
$monto_c=$_POST["txtmonto"]; $operacion=$_POST["txtoperacion"];$grupo=$_POST["txtgrupo"];
$fecha=asigna_fecha_hoy(); $monto_c=formato_numero($monto_c);if(is_numeric($monto_c)){$monto=$monto_c;} else{$monto=0;}
$equipo = getenv("COMPUTERNAME"); $MInf_Usuario=$equipo." ".date("d/m/y H:i a"); echo "ESPERE POR FAVOR INCLUYENDO....","<br>"; $url="Det_inc_traspasos.php?codigo_mov=".$codigo_mov;
