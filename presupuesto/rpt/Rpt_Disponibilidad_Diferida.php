...
<html>
<head>
<title>SIA CONTABILIDAD PRESUPUESTARIA (Reporte Disponibilidad Diferida)</title>
        ...
        <tr>
          <td height="19"><table width="824" border="0">
            <tr>
              ...
              <td width="302"><span class="Estilo15"><?echo $titulo?></span></td>
              <td width="208"><span class="Estilo15"><?echo $titulo?></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
