...
<html>
<head>
<title>SIA CONTABILIDAD PRESUPUESTARIA (Reporte Asignacion Presupuestaria)</title>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="62"><span class="Estilo5"><input class="Estilo10" name="txtcod_fuented" type="text" id="txtcod_fuented" onFocus="encender(this)" onBlur="apagar(this)" size="5" maxlength="2" value="<?echo $fuente_d?>" onkeypress="return stabular(event,this)">
        ...
        <tr>
          <td height="19"><table width="828" border="0">
            <tr>
              ...
              <td width="61"><span class="Estilo5"><input class="Estilo10" name="txtcod_fuenteh" type="text" id="txtcod_fuenteh" onFocus="encender(this)" onBlur="apagar(this)" size="5" maxlength="2" value="<?echo $fuente_h?>" onkeypress="return stabular(event,this)"></span></td>
