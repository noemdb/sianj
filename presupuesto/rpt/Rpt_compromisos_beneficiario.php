...
<html>
<head>
<title>SIA CONTABILIDAD PRESUPUESTARIA (Reporte de Compromisos por Beneficiario)</title>
        ...
        <tr>
          <td height="30"><table width="827" border="0">
            <tr>
              ...
              <td width="53"><span class="Estilo5"><span class="Estilo5"><input class="Estilo10" name="txttipo_compromiso" type="text"  id="txtdoc_compromiso_d" size="6" maxlength="4" value="<?echo $doc_comp_d?>" onFocus="encender(this);" onBlur="apagar(this)"  onchange="chequea_tipo(this.form);">  </span></td>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="51"><span class="Estilo5"> <input class="Estilo10" name="btfuented" type="button" id="btfuented" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('Cat_fuentesd.php?criterio=','SIA','','750','500','true')" value="...">   </span></td>
        ...
        <tr>
          <td height="19"><table width="828" border="0">
            <tr>
              ...
              <td width="54"><span class="Estilo5"> <input class="Estilo10" name="btfuenteh" type="button" id="btfuenteh" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('Cat_fuentesh.php?criterio=','SIA','','750','500','true')" value="..."> </span></td>
        ...
        <tr>
          <td height="19"><table width="829" border="0">
            <tr>
              ...
              <td width="330"><span class="Estilo5"><input class="Estilo10" name="btced_rifd" type="button" id="btced_rifd" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('Cat_beneficiarios_d.php?criterio=','SIA','','750','500','true')" value="...">  </span></td>
              ...
              <td width="67"><span class="Estilo5"><input class="Estilo10" name="btced_rifh" type="button" id="btced_rifh" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('Cat_beneficiarios_h.php?criterio=','SIA','','750','500','true')" value="...">   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
