...
<html>
<head>
<title>SIA CONTABILIDAD PRESUPUESTARIA (Reporte de Rendicion de Credito Adicional)</title>
        ...
        <tr>
          <td height="19"><table width="827" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="100"><span class="Estilo5"><input class="Estilo10" name="txtref_imput_presu" type="text" id="txtref_imput_presu" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $referencia_d?>" size="10" maxlength="8"> </span></td>
			  <td width="500"><span class="Estilo5"><input class="Estilo10" name="btref_cred" type="button" id="btref_cred" title="Abrir Catalogo Cr&eacute;ditos Adicional" onClick="VentanaCentrada('../Cat_cred_adic.php?criterio=','SIA','','750','500','true')" value="..."></span></td>
            </tr>
          </table></td>
        </tr>
        <tr><td height="19">&nbsp;</td></tr>
        ...
        <tr>
          <td height="30"><table width="827" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="230"><span class="Estilo5"><input class="Estilo10" name="txtcod_presupd" type="text" id="txtcod_presupd" size="40" maxlength="35" onFocus="encender(this); " onBlur="apagar(this);" value="<?echo $cod_presup_d?>" >  </span></td>
              <td width="370"><span class="Estilo5"> <input class="Estilo10" name="btCodPre" type="button" id="btCodPre" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onClick="VentanaCentrada('Cat_codigos_presupd.php?criterio=','SIA','','750','500','true')" value="...">  </span></td>
            </tr>
          </table></td>
        </tr>
        ...
        <tr>
          <td height="30"><table width="827" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="230"><span class="Estilo5"> <input class="Estilo10" name="txtcod_presuph" type="text" id="txtcod_presuph" size="40" maxlength="35" onFocus="encender(this); " onBlur="apagar(this);" value="<?echo $cod_presup_h?>" >  </span></td>
              <td width="370"><span class="Estilo5"><input class="Estilo10" name="btCodPre2" type="button" id="btCodPre2" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onClick="VentanaCentrada('Cat_codigos_presuph.php?criterio=','SIA','','750','500','true')" value="..."> </span></td>
            </tr>
          </table></td>
        </tr>
		<tr><td height="19">&nbsp;</td></tr>
        ...
        <tr>
          <td height="18"><table width="827" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="5"><input class="Estilo10" name="txtFechad" type="hidden" id="txtFechad" value="<?echo $fecha_d?>" ></td>
			  <td width="600"><span class="Estilo5"> <input class="Estilo10" name="txtFechah" type="text" id="txtFechah" size="12" maxlength="10" onFocus="encender(this); " onBlur="apagar(this);"  value="<?echo $fecha_h?>" onchange="checkrefecha(this.form)" >
