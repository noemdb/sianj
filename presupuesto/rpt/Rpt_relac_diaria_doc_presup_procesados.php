...
<html>
<head>
<title>SIA CONTABILIDAD PRESUPUESTARIA (Relacion Diaria de Documentos Procesados)</title>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="211"><span class="Estilo5"><input class="Estilo10" name="txtcod_presupd" type="text" id="txtcod_presupd" size="34" maxlength="32" onFocus="encender(this); " onBlur="apagar(this);" value="<?echo $cod_presup_d?>" > </span></td>
              <td width="50"><span class="Estilo5"> <input class="Estilo10" name="btCodPre" type="button" id="btCodPre" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onClick="VentanaCentrada('Cat_codigos_presupd.php?criterio=','SIA','','750','500','true')" value="..."> </span></td>
              <td width="55"><span class="Estilo5">HASTA : </span></td>
              <td width="216"><span class="Estilo5"><input class="Estilo10" name="txtcod_presuph" type="text" id="txtcod_presuph" size="34" maxlength="32" onFocus="encender(this); " onBlur="apagar(this);" value="<?echo $cod_presup_h?>" ></span></td>
              <td width="52"><span class="Estilo5"><input class="Estilo10" name="btCodPre2" type="button" id="btCodPre2" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onClick="VentanaCentrada('Cat_codigos_presuph.php?criterio=','SIA','','750','500','true')" value="..."> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="19"><table width="896" border="0">
            <tr>
			  ...
			  <td width="211"><input class="Estilo10" name="txtFechah" type="hidden" id="txtFechah" value="<?echo $user?>" ></td>
			</tr>
          </table></td>
        </tr>
		<tr>
