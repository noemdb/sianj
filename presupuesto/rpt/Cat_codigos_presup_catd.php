...
<html>
<head>
<title>SIA CONTABILIDAD PRESUPUESTARIA (Catalogo de Categorias)</title>
...
<?
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron Categorias</font>";$pagina=1; $inicio=1; $final=1; $numPags=1;
                ...
                echo "<th height='20' bgcolor='#99CCFF'><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=denominacion_cat&criterio=".$txt_criterio."'>Denominación</a></th>";
                $linea=0; $Salir=false;
