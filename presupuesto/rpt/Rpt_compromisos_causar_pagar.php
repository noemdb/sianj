        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="285"><span class="Estilo5"> <input class="Estilo10" name="bttipo_comp" type="button" id="bttipo_comp" title="Abrir Catalogo Tipos de Compromiso" onClick="VentanaCentrada('Cat_tipos_compd.php?criterio=','SIA','','750','500','true')" value="...">              </span></td>
		 ...
		 <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="180"><span class="Estilo5"> <input class="Estilo10" name="txtnro_doc_d" type="text" id="txtnro_doc_d" size="40" maxlength="50" value="<?echo $nro_doc_d?>" onFocus="encender(this);" onBlur="apagar(this);"  onchange="checkrefe_comp(this.form);">
              </span></td>
			  <td width="120"><span class="Estilo5"><input class="Estilo10" name="btdoc_d" type="button" id="btdoc_d" title="Abrir Catalogo Numero Documento" onClick="VentanaCentrada('Cat_documento_d.php?criterio=','SIA','','750','500','true')" value="...">
              </span></td>
              <td width="202"><span class="Estilo5"><input class="Estilo10" name="txtnro_doc_h" type="text" id="txtnro_doc_h" size="40" maxlength="50" value="<?echo $nro_doc_h?>" onFocus="encender(this);" onBlur="apagar(this);"  onchange="checkrefe_comp(this.form);">
              </span></td>
			  <td width="58"><span class="Estilo5"><input class="Estilo10" name="btdoc_h" type="button" id="btdoc_h" title="Abrir Catalogo Numero Documento" onClick="VentanaCentrada('Cat_documento_h.php?criterio=','SIA','','750','500','true')" value="...">
              </span></td>              
            </tr>
          </table></td>
        </tr>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="238"><span class="Estilo15"><strong><? echo $titulo; ?></span></td>
			  <td width="119"><span class="Estilo5"> </span></td>
              <td width="234"><span class="Estilo15"><strong><? echo $titulo; ?></span></td>
