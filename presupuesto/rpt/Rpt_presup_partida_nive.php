...
if ($_GET){$cod_presup_d=$_GET["cod_presup_d"];$cod_presup_h=$_GET["cod_presup_h"];$cod_fuente_d=$_GET["cod_fuente_d"];$cod_fuente_h=$_GET["cod_fuente_h"];$tipo_deuda=$_GET["tipo_deuda"];}
...
if ($tipo_deuda=='CA')
{
        ...
        $oRpt->setXML("Rpt_presup_partida_niveles.xml");
        $oRpt->setUser("$user");
