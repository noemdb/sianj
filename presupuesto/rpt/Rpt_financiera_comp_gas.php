...
if ($_GET){$cod_presup_d=$_GET["cod_presupd"];$cod_presup_h=$_GET["cod_presuph"];$cod_fuente_d=$_GET["cod_fuented"];$cod_fuente_h=$_GET["cod_fuenteh"];$mes=$_GET["mes"];$tipo=$_GET["tipo"];}
...
if ($tipo=='C')
{
        $sSQL = "SELECT PRE020.Cod_Presup, PRE020.Denominacion, PRE020.Asignado, PRE020.Traslados, PRE020.Trasladon, 
                PRE020.Adicion, PRE020.Disminucion, PRE020.Compromiso, PRE020.Causado, PRE020.Pagado, PRE020.Disponible,
                (PRE020.Trasladon-PRE020.Traslados+PRE020.Adicion-PRE020.Disminucion) AS Modificaciones,  
                (PRE020.Asignado-PRE020.Trasladon-PRE020.Traslados+PRE020.Adicion-PRE020.Disminucion) AS Asig_Actualizada, 
                (PRE020.Asignado-PRE020.Trasladon-PRE020.Traslados+PRE020.Adicion-PRE020.Disminucion-PRE020.Causado) AS Absoluto
                FROM PRE020 WHERE ".$criterio."
                ORDER BY PRE020.Cod_Presup";

        $oRpt = new PHPReportMaker();
        $oRpt->setXML("Rpt_financiera_comp_gasto.xml");
        $oRpt->setUser("$user");
...
else
{
        ...
        (PRE020.Trasladon-PRE020.Traslados+PRE020.Adicion-PRE020.Disminucion) AS Modificaciones,  
        (PRE020.Asignado-PRE020.Trasladon-PRE020.Traslados+PRE020.Adicion-PRE020.Disminucion) AS Asig_Actualizada, 
        (PRE020.Asignado-PRE020.Trasladon-PRE020.Traslados+PRE020.Adicion-PRE020.Disminucion-PRE020.Pagado) AS Absoluto
         FROM PRE020 WHERE ".$criterio."
         ORDER BY PRE020.Cod_Presup";

        $oRpt = new PHPReportMaker();
        $oRpt->setXML("Rpt_financiera_comp_gasto_tipo.xml");
        $oRpt->setUser("$user");
        $oRpt->setPassword("$password");
        $oRpt->setConnection("localhost");
        $oRpt->setDatabaseInterface("postgresql");
