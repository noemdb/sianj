...
if ($_GET){$cod_presup_cat_d==$_GET["cod_presup_cat_d="];$cod_fuente_d=$_GET["cod_fuented"];$cod_fuente_h=$_GET["cod_fuenteh"];$mes=$_GET["mes"];}
...
/*$sSQL = "SELECT PRE020.Cod_Presup, PRE020.Denominacion, PRE020.Asignado, PRE020.Traslados, PRE020.Trasladon, 
                 ...
                 (PRE020.Compromiso-PRE020.Causado) AS Cuentas_Pagar
                 FROM PRE020 WHERE ".$criterio."
                 ORDER BY PRE020.Cod_Presup";*/
$sSQL = "SELECT PRE020.Cod_Presup, PRE020.Denominacion, PRE020.Asignado, PRE020.Traslados, PRE020.Trasladon, PRE020.Adicion, PRE020.Disminucion, PRE020.Compromiso, PRE020.Causado, PRE020.Pagado, PRE020.Disponible  FROM PRE020 PRE020  ORDER BY PRE020.Cod_Presup";


        $oRpt = new PHPReportMaker();
        $oRpt->setXML("Rpt_resumen_general_ejec_presup.xml");
        $oRpt->setUser("$user");
