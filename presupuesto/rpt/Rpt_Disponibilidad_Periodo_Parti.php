...
if ($_GET){$cod_presup_d=$_GET["cod_presupd"];$cod_presup_h=$_GET["cod_presuph"];$cod_fuente_d=$_GET["cod_fuented"];$cod_fuente_h=$_GET["cod_fuenteh"];$mes=$_GET["mes"];$asig_global=$_GET["asig_global"];$mostrar_cuentas=$_GET["mostrar_cuentas"];}
...
$sSQL = "SELECT PRE020.Cod_Presup, PRE020.Denominacion, PRE020.Asignado, PRE020.Traslados, PRE020.Trasladon, 
        ...
        $oRpt->setXML("Rpt_Disponibilidad_Periodo_Partidas.xml");
        $oRpt->setUser("$user");
...
$sSQL = "SELECT PRE020.Cod_Presup, PRE020.Denominacion, PRE020.Asignado, PRE020.Traslados, PRE020.Trasladon, 
        ...
        $oRpt = new PHPReportMaker();
        $oRpt->setXML("Rpt_Disponibilidad_Periodo_Partidas_most_cuen.xml");
        $oRpt->setUser("$user");
        $oRpt->setPassword("$password");
        $oRpt->setConnection("localhost");
        $oRpt->setDatabaseInterface("postgresql");
