...
<html>
<head>
<title>SIA CONTABILIDAD PRESUPUESTARIA (Reporte de Ajustes)</title>
        ...
        <tr>
          <td height="30"><table width="827" border="0">
            <tr>
			  ...
			  <td width="59"><span class="Estilo5"> <input class="Estilo10" name="txttipo_ajusted" type="text" id="txttipo_ajusted" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $tipo_ajuste_d?>" size="7" maxlength="7"> </span></td>
              <td width="275"><span class="Estilo5"><input class="Estilo10" name="btdoc_comp" type="button" id="btdoc_comp" title="Abrir Catalogo Documentos Compromiso" onClick="VentanaCentrada('Cat_tipo_ajusted.php?criterio=','SIA','','750','500','true')" value="...">   </span></td>
              <td width="59"><span class="Estilo5"><input class="Estilo10" name="txttipo_ajusteh" type="text" id="txttipo_ajusteh" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $tipo_ajuste_h?>" size="7" maxlength="7">  </span></td>
              <td width="205"><span class="Estilo5"><input class="Estilo10" name="btdoc_comp" type="button" id="btdoc_comp" title="Abrir Catalogo Documentos Compromiso" onClick="VentanaCentrada('Cat_tipo_ajusteh.php?criterio=','SIA','','750','500','true')" value="...">  </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="275"><span class="Estilo5"> <input class="Estilo10" name="txtreferencia_d" type="text" id="txtreferencia_d" size="10" maxlength="8" value="<?echo $referencia_d?>" onFocus="encender(this);" onBlur="apagar(this);"  onchange="checkrefe_comp(this.form);">  </span></td>
              <td width="59"><span class="Estilo5">              </span></td>
              <td width="264"><span class="Estilo5"><input class="Estilo10" name="txtreferencia_h" type="text" id="txtreferencia_h" size="10" maxlength="8" value="<?echo $referencia_h?>" onFocus="encender(this);" onBlur="apagar(this);"  onchange="checkrefe_comp(this.form);">  </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
