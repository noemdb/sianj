...
if (pg_ErrorMessage($conn)) { ?> <script language="JavaScript">   muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');  </script> <?}
  ...
  if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('EL BIEN INMUEBLE NO EXISTE');</script> <? }
    else{ $error=1; $resultado=pg_exec($conn,"SELECT elimina_bien017('$cod_bien_inm')"); 
