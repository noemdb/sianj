...
$criterio  .= "(bien015.cod_empresa>='$cod_empresad' and bien015.cod_empresa<='$cod_empresah') AND";
$criterio  .= "(bien015.cod_dependencia>='$cod_dependenciad' and bien015.cod_dependencia<='$cod_dependenciah') AND";
$criterio  .= "(bien015.cod_direccion>='$cod_direcciond' and bien015.cod_direccion<='$cod_direccionh') AND";
$criterio  .= "(bien015.cod_departamento>='$cod_departamentod' and bien015.cod_departamento<='$cod_departamentoh') AND";
$criterio  .= "(bien015.fecha_desincorporado>='$fecha_desde' and bien015.fecha_desincorporado<='$fecha_hasta') AND";
//$criterio  .= "(bien015.fecha_incorporacion>='$fecha_desde' and bien015.fecha_incorporacion<='$fecha_hasta') AND";
$criterio .= " bien015.desincorporado='S' ";
...
?> <script language="JavaScript">  muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS'); </script> <?php
    ...
    $sSQL       = "SELECT bien015.cod_bien_mue, bien015.cod_clasificacion, bien015.num_bien, bien015.denominacion, bien015.cod_dependencia, bien015.cod_direccion, bien015.cod_departamento, 
              ...
              bien015.valor_incorporacion, to_char(bien015.fecha_incorporacion,'DD/MM/YYYY') as fechai, bien015.tipo_incorporacion, bien015.cod_contablea, bien015.fecha_desincorporado, bien015.cod_ContableD, bien015.cod_Imp_Presup, 
    ...
    if (($tipo_rep == "PDF")) {
        ...
        class PDF extends FPDF
        {
            function Header()
            {
                ...
                $this->Cell(20, 5, 'CODIGO BIEN', 1, 0);
                ...
                $this->Cell(20, 5, 'F.DESINCORP.', 1, 1, 'L');
        ...
        while ($registro = pg_fetch_array($res)) {
            ...
            $pdf->Cell(20, 3, $cod_bien_mue, 0, 0, 'L');
            $x = $pdf->GetX();
            $y = $pdf->GetY();
            $n = 90;
            $pdf->SetXY($x + $n, $y);
            ...
            $pdf->Cell(20, 3, $fecha_desincorporado, 0, 1, 'L');
