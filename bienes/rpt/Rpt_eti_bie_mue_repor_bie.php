         ...
         require('../../class/fpdf/fpdf.php');
		  ...
		  while($registro=pg_fetch_array($res)){ $i=$i+1;
			...
			$cod_grupo=$cod_dependencia;
 			...
 			$temp_codigo=$cod_bien_mue; $temp_den_dep=$denominacion_dep;
			
			
			
			$pdf->Cell(60,3,'',"LRT",1,'L');
			
			
			$pdf->Cell(10,5,'',"L",0,'L');
			$pdf->Cell(40,5,'DEPARTAMENTO: '.$cod_dependencia,0,0,'L');
			$pdf->Cell(10,5,'',"R",1,'L');
			
			$pdf->Cell(60,3,'',"LR",1,'L');
			
			$pdf->Cell(10,5,'',"L",0,'L');
			$pdf->Cell(40,5,'CODIGO: '.$temp_codigo,0,0,'L');
			$pdf->Cell(10,5,'',"R",1,'L');
			
			$pdf->Cell(60,3,'',"LRB",1,'L');
