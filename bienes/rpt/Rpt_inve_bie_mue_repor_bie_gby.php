...
WHERE bien001.cod_dependencia = bien015.cod_dependencia AND bien004.Codigo = bien015.edo_conservacion AND ".$criterio."  ORDER BY bien005.cod_dependencia,bien015.cod_bien_mue";
