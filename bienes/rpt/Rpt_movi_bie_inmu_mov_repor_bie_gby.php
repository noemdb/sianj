...
$date = date("d-m-Y");$hora = date("H:i:s a");$Sql=""; $php_os=PHP_OS;  $tipo_rep="PDF"; $fecha_d="01/".substr($mes_proceso,0,2)."/".substr($mes_proceso,3,4);
...
$mordenado=" bien014.cod_dependencia,bien014.cod_bien_inm"; if($agrup_dep=="SI"){ $mordenado=" bien014.cod_dependencia,bien014.cod_direccion,bien014.cod_departamento,bien014.cod_bien_inm";}
if($ordenado=="N"){$mordenado=" bien014.cod_dependencia,bien014.num_bien"; if($agrup_dep=="SI"){ $mordenado=" bien014.cod_dependencia,bien014.cod_direccion,bien014.cod_departamento,bien014.cod_bien_inm";} }
	     ...
	     $filas=pg_num_rows($res); if($filas>=1){ $registro=pg_fetch_array($res,0); $cod_dependencia=$registro["cod_dependencia"];  $prev_cod_dep=$registro["cod_dependencia"];
		  ...
		  class PDF extends FPDF{
			function Header(){ global $criterio1; global $Nom_Emp; global $cod_dependencia; global $denominacion_dep;  global $denom_departamento; global $direccion_dep; global $agrup_dep;  global $mes_proceso;
				...
				$this->Cell(200,10,'RELACION MOVIMIENTOS DE BIENES INMUEBLES',0,0,'C');
