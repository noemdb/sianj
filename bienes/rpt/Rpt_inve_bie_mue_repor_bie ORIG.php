...
WHERE bien001.cod_dependencia = bien015.cod_dependencia AND bien004.Codigo = bien015.edo_conservacion AND ".$criterio."  order by  ".$mordenado;
	...
	if($tipo_rep=="PDF"){  $res=pg_query($sSQL); $cod_dependencia=""; $denominacion_dep="";  $subtotal=0; $fin=0; $prev_cod_dep=""; $direccion_dep=""; $denom_departamento=""; $cod_departamento="";
		  ...
		  while($registro=pg_fetch_array($res)){ $i=$i+1;
			...
			$cod_bien_mue=$registro["cod_bien_mue"]; $denominacion=$registro["denominacion"];
            $denominacion=$registro["denominacion"]." ".$registro["caracteristicas"];  			
			$edo_bien=$registro["edo_bien"]; $denom_departamento=$registro["denom_departamento"]; $cod_departamento=$registro["cod_departamento"]; 
