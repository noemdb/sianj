           ...
           <tr>
             <td><table width="850">
               <tr>
                 ...
                 <td width="320"><span class="Estilo5"><input name="txtcod_bien_inm_d" type="text" class="Estilo5" id="txtcod_bien_inm_d" size="30" maxlength="30"  onFocus="encender(this)" onBlur="apagar(this)" class="Estilo10" value="<?echo $cod_bien_inmd?>">
                    <input name="btcat_biend" type="button" id="btcat_biend" title="Abrir Catalogo de Bienes Muebles" onClick="VentanaCentrada('Cat_bienes_inmueblesd.php?criterio=','SIA','','750','500','true')" value="...">  </span></td>
                 <td width="300"><span class="Estilo5"><input name="txtcod_bien_inm_h" type="text" class="Estilo5" id="txtcod_bien_inm_h" size="30" maxlength="30"  onFocus="encender(this)" onBlur="apagar(this)" class="Estilo10" value="<?echo $cod_bien_inmh?>">
                     <input name="btcat_bienh" type="button" id="btcat_bienh" title="Abrir Catalogo de Bienes Muebles" onClick="VentanaCentrada('Cat_bienes_inmueblesh.php?criterio=','SIA','','750','500','true')" value="...">   </span></td>
                 </tr>
             </table></td>
           </tr>
           <tr>
           ...
           <tr>
             <td><table width="850">
               <tr>
                 ...
                 <td width="320"><span class="Estilo5"><input name="txtcod_direcciond" type="text" class="Estilo5" id="txtcod_direcciond" onFocus="encender(this)" onBlur="apagar(this)" size="5" maxlength="4" class="Estilo10" value="<?echo $cod_direcciond?>" >
                 ...
                 <td width="300"><span class="Estilo5"><input name="txtcod_direccionh" type="text" class="Estilo5" id="txtcod_direccionh" onFocus="encender(this)" onBlur="apagar(this)" size="5" maxlength="4" class="Estilo10" value="<?echo $cod_direccionh?>" >
           ...
           <tr>
             <td><table width="850">
               <tr>
                 ...
                 <td width="320"><span class="Estilo5"><input name="txtcod_departamentod" type="text" class="Estilo5" id="txtcod_departamentod" size="10" maxlength="8"  onFocus="encender(this)" onBlur="apagar(this)" class="Estilo10" value="<?echo $cod_departamentod?>">
                 ...
                 <td width="300"><span class="Estilo5">  <input name="txtcod_departamentoh" type="text" class="Estilo5" id="txtcod_departamentoh" size="10" maxlength="8"  onFocus="encender(this)" onBlur="apagar(this)" class="Estilo10" value="<?echo $cod_departamentoh?>">
		   ...
		   <tr>
             <td><table width="850">
               <tr>
                 ...
                 <td width="320"><span class="Estilo5"><input name="txtcod_empresad" type="text" class="Estilo5" id="txtcod_empresad" size="10" maxlength="8"  onFocus="encender(this)" onBlur="apagar(this)" class="Estilo10" value="<?echo $cod_empresad?>">
