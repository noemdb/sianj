...
(BIEN016.cod_departamento>='$cod_departamentod' AND BIEN016.cod_departamento<='$cod_departamentoh')";
   ...
   {
         // LLAMAR A PHP_REPORT
         $sSQL = "SELECT BIEN016.Cod_Bien_Sem, BIEN016.Cod_Clasificacion, substr(BIEN016.Cod_Clasificacion,1,1) as grupo, substr(BIEN016.Cod_Clasificacion,3,2) as subgrupo, substr(BIEN016.Cod_Clasificacion,6,1) as seccion, BIEN016.Num_Bien, BIEN016.Denominacion, BIEN016.Cod_Dependencia, BIEN001.Denominacion_Dep, BIEN001.Direccion_Dep, BIEN016.Valor_Incorporacion, BIEN016.Caracteristicas, BIEN016.Raza, BIEN016.Color, BIEN016.Color, BIEN016.Sexo, BIEN016.Uso, BIEN016.Tam_Peso, BIEN016.Fecha_Nacimiento, BIEN016.Edad 
	          FROM BIEN001, BIEN016 
                  WHERE BIEN001.Cod_Dependencia = BIEN016.Cod_Dependencia  AND ".$criterio." ORDER BY BIEN016.Cod_Bien_Sem";

            $oRpt = new PHPReportMaker();
            $oRpt->setXML("Rpt_fi_bie_semo_repor_semo.xml");
            $oRpt->setUser("$user");
