...
<html>
<head>
<title>SIA CONTROL DE BIENES NACIONALES (Reportes Movimientos de Bienes Muebles)</title>
			...
			<tr>		      
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">
                 ...
                 <td> <div align="center"><input name="btgenerar" type="button" id="btgenerar" value="GENERAR" onClick="javascript:Llama_Rpt_movi_bie_mue_mov_repor_bie('<?echo $nombre_rpt;?>');">   </div></td>
