...
if (pg_ErrorMessage($conn)){ ?><script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script><?}
  ...
  if($error==0){ $sfecha=formato_aaaammdd($fecha); $sql="SELECT ACTUALIZA_BIEN053(1,'$cod_bien_mue','$cod_componente','$des_componente','$marca','$modelo','$serial1','$serial2','$campo_str1','$campo_str2',$monto1,$monto2)";
