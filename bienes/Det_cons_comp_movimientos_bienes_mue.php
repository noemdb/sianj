...
<body>
 <table width="845" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td>
<?if (!$_GET){ $criterio='';  $referencia='';  $fecha=''; $tipo_comp='';} else{$criterio=$_GET["criterio"];  $referencia=substr($criterio,0,8); $fecha=substr($criterio,8,10);  $tipo_comp=substr($criterio,18,5);  }
