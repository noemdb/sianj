...
$codigo=$_POST["txtCodigo_Parroquia"]; $nombre=$_POST["txtNombre_Parroquia"]; echo "ESPERE POR FAVOR INCLUYENDO....","<br>"; $error=0;
...
pg_close(); if ($error==0){?><script language="JavaScript">document.location ='Act_parroquias.php';</script> <? } else {?>  <script language="JavaScript">history.back();</script> <? }?>