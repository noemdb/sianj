<?include ("../class/ventana.php"); $equipo=getenv("COMPUTERNAME");  $mcod_m="BIEN025".$usuario_sia.$equipo; 
            ...
            <td><table width="630">
              <tr>
                ...
                <td width="400"><span class="Estilo5"><input name="txtcod_bien_mue" type="text" id="txtcod_bien_mue" size="30" maxlength="30"  onFocus="encender(this)" onBlur="apagar(this)" class="Estilo10">
                     <input class="Estilo10" name="btcod_bien" type="button" id="btcod_bien" title="Abrir Catalogo de Bienes Inmuebles" onClick="VentanaCentrada('Cat_bienes_muebles_desin.php?criterio=','SIA','','750','500','true')" value="..."></span></td>
              </tr>
            </table></td>
          </tr>
		  <tr>
            ...
            <td><table width="630">
              <tr>
                ...
                <td width="450"><span class="Estilo5"><input class="Estilo10" name="txtcodigo" type="text" id="txtcodigo" size="5" maxlength="3"  onFocus="encender(this)" onBlur="apagar(this)">
                    <input class="Estilo10" name="bttipomov" type="button" id="bttipomov" title="Abrir Catalogo Tipos de Movimiento" onClick="VentanaCentrada('Cat_movim_bienes_mueblesd.php?criterio=','SIA','','750','500','true')" value="...">    </div></td>
              </tr>
            </table></td>
          </tr>
          <tr>
