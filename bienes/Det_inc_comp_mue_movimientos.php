<?include ("../class/conect.php");  include ("../class/funciones.php"); $equipo=getenv("COMPUTERNAME");  $mcod_m="BIEN025".$usuario_sia.$equipo; 
...
<html>
<head>
<title>SIA CONTROL DE BIENES NACIONALES (Detalles Comprobante Movimiento)</title>
...
<body>
  <table width="888" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td  width="262" align="center"><input name="btGenComp" type="button" id="btGenComp" value="Generar Comprobante" title="Generar Comprobante" onclick="javascript:LlamarURL('Gen_Comp_mue_movimientos.php?codigo_mov=<?echo $codigo_mov?>')"></td>
