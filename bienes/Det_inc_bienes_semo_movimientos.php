 ...
 <table width="845" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td align="left"><table width="840" border="0" align="left">
          <tr>
            <td width="222" align="center" valign="middle"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar Código al Movimiento" onclick="javascript:LlamarURL('Inc_bienes_Semo_Movimientos.php?codigo_mov=<?echo $codigo_mov?>')"></td>
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:enviar('<? echo $codigo_mov; ?>','<? echo $registro["cod_bien"]; ?>');">
           ...
           <td width="200" align="left"><? echo $registro["tipo_movimiento"]; ?></td>
           <td width="500" align="left"><? echo $registro["denomina_tipo"]; ?></td>
           <td width="100" align="left"><? echo $registro["gen_comprobante"]; ?></td>
           <td width="100" align="left"><? echo $registro["cantidad"]; ?></td>
