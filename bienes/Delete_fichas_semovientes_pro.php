...
$cod_bien_sem=$_GET["Gcod_bien_sem"];  $equipo = getenv("COMPUTERNAME"); $minf_usuario = $equipo." ".date("d/m/y H:i a");
...
if (pg_ErrorMessage($conn)) { ?> <script language="JavaScript">   muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');  </script> <?}
  ...
  if ($filas==0){$error=1; ?> <script language="JavaScript"> muestra('EL BIEN SEMOVIENTE');</script> <? }
    else{ $error=1; $resultado=pg_exec($conn,"SELECT elimina_bien016('$cod_bien_sem')"); 
