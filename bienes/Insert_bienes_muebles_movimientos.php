...
$url="Det_inc_bienes_mue_movimientos.php?codigo_mov=".$codigo_mov;
  ...
  if($error==0)
    {
      ...
      $resultado=pg_exec($conn,"SELECT INCLUYE_BIEN050('$codigo_mov','','$cod_bien_mue','$sfecha','$tipo_movimiento','','$gen_comprobante','$cantidad','$monto_c')");
