...
var Valido=true;
   if(f.txtcod_bien_mue.value==""){alert("Código del Inmueble no puede estar Vacio"); return false; } else{f.txtcod_bien_mue.value=f.txtcod_bien_mue.value.toUpperCase();}
