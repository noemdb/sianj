...
$url="Act_cal_prestaciones.php?Gcodigo=C".$cod_empleado_d; $cant_trab=0; $hora1=time();
if($m1>$m2) { $error=0; ?> <script language="JavaScript">muestra('FECHA INVALIDA, FECHA DEBE SER MENOR A: '+'<? echo $fecha_tope; ?>');   </script> <? }
