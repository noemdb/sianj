...
$StrSQL="Select fecha_pago from NOM032 WHERE cod_empleado='$cod_empleado' order by fecha_pago desc";
...
<input name="txtfecha_calculo" type="text" id="txtfecha_calculo" size="10" maxlength="10"  value="<?echo $fecha_calculo?>" readonly>