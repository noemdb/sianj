...
if (pg_ErrorMessage($conn)){ ?> <script language="JavaScript">  muestra('OCURRIO UN ERROR CONECTandO LA BASE DE DATOS'); </script> <?}
   ...
   $sSQL = "SELECT *  FROM ".$criterio."  and (tipo_nomina>='".$tipo_nomina_d."' and tipo_nomina<='".$tipo_nomina_h."') and
      ...
      header("Content-Disposition: attachment; filename=Relacion_caja_ahorros.xls"); 	
	  ?>
	   <table border="0" cellspacing='0' cellpadding='0' align="left">
		 <tr height="20">
		    <td width="100" align="left" ><strong></strong></td>
			<td width="100" align="left" ><strong></strong></td>
			<td width="400" align="center" > <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><strong>RELACION DE CAJA DE AHORROS</strong></font></td>
		 </tr>
		 <tr height="20">
		 </tr>
		 <?if($tipo_nomina_d==$tipo_nomina_h){ ?>
		 ...
		 <tr height="20" >
		   ...
		   <td width="100" align="center" bgcolor="#A4A4A4"><strong>PRESTAMO 1</strong></td>
		   <td width="100" align="center" bgcolor="#A4A4A4"><strong>PRESTAMO 2</strong></td>
		   <td width="100" align="center" bgcolor="#A4A4A4"><strong>PRESTAMO 3</strong></td>
		   <td width="100" align="center" bgcolor="#A4A4A4"><strong>TOTAL PRESTAMOS</strong></td>
		   <td width="100" align="center" bgcolor="#A4A4A4"><strong>TOTAL EMPLEADO</strong></td>
		   <td width="100" align="center" bgcolor="#A4A4A4"><strong>APORTE PATRONAL</strong></td>
		   <td width="100" align="center" bgcolor="#A4A4A4"><strong>TOTAL</strong></td>
		 </tr>      
	  <? 
