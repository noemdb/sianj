  ...
  if($tipo_rpt=="PDF"){	 $res=pg_query($sSQL); $prev_tipo=""; $prev_den_nom=""; $prev_dep=""; $prev_den_dep=""; $prev_emp=""; $filas=pg_num_rows($res);
      ...
      class PDF extends FPDF{
		...
		function Footer(){ $ffechar=date("d-m-Y");$fhorar=date("H:i:s a"); 
			...
			$this->Cell(10,5,'',0,0);
			$this->Cell(45,5,'Elaborado Por:',1,0,'C');
			$this->Cell(45,5,'Revisado Por:',1,0,'C');
			$this->Cell(45,5,'Conformidad Presupuestaria',1,0,'C');
			$this->Cell(45,5,'Aprobado Por:',1,0,'C');
			$this->Cell(10,5,'',0,1);			
			$this->Cell(10,10,'',0,0);
			...
			$this->Cell(10,10,'',0,1);			
			$this->Cell(10,5,'',0,0);
			$this->Cell(45,5,'Analista de Nomina',1,0,'C');
			$this->Cell(45,5,'Coordinacion de Nomina',1,0,'C');
			$this->Cell(45,5,'Coordinacion  Administrativa',1,0,'C');
			$this->Cell(45,5,'Directora de Recursos Humanos',1,0,'C');
			$this->Cell(10,5,'',0,1);
