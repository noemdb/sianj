...
if (pg_ErrorMessage($conn)){ ?> <script language="JavaScript">  muestra('OCURRIO UN ERROR CONECTandO LA BASE DE DATOS'); </script> <?}
   ...
   $sSQL = "SELECT *  FROM ".$criterio."  and (tipo_nomina>='".$tipo_nomina_d."' and tipo_nomina<='".$tipo_nomina_h."') and
      ...
      header("Content-Disposition: attachment; filename=Relacion_tesoreria_nacional.xls"); 	
	  ?>
	   <table border="0" cellspacing='0' cellpadding='0' align="left">
		 <tr height="20">
		    <td width="100" align="left" ><strong></strong></td>
			<td width="400" align="center" > <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><strong>RELACION DE TESORERIA SEGURIDAD SOCIAL</strong></font></td>
		 </tr>
		 <tr height="20">
		 </tr>
		 ...
		 <tr height="20" >
		   ...
		   <td width="100" align="center" bgcolor="#A4A4A4"><strong>SUELDO+CONPENSACION</strong></td>
