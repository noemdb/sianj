...
if (pg_ErrorMessage($conn)){ ?><script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script><?}
   ...
   $sSQL = "SELECT nom003.tipo_nomina, nom001.descripcion, nom003.cod_concepto, nom002.denominacion, nom003.consecutivo, nom003.accion, nom003.rango_inicial, nom003.rango_final, nom003.Calculo1, NOM003.Calculo2, NOM003.CalculoFinal  
           FROM NOM001 NOM001, NOM002 NOM002, NOM003 NOM003  WHERE NOM003.Cod_Concepto = NOM002.Cod_Concepto AND NOM003.Tipo_Nomina = NOM001.Tipo_Nomina AND NOM003.Tipo_Nomina = NOM002.tipo_nomina  AND
                   NOM002.Tipo_Nomina>='".$tipo_nomina_d."' AND NOM002.Tipo_Nomina<='".$tipo_nomina_h."'  AND
                   NOM002.Cod_Concepto>='".$cod_concepto_d."' AND NOM002.Cod_Concepto<='".$cod_concepto_h."'ORDER BY nom003.tipo_nomina, nom003.cod_concepto, nom003.consecutivo";

  if($tipo_rpt=="HTML"){
	  $oRpt = new PHPReportMaker();
	  $oRpt->setXML("Cat_formu_concep_cata_re.xml");
	  $oRpt->setUser("$user");
  ...
  if($tipo_rpt=="PDF"){	 $res=pg_query($sSQL);  $tipo_nomina_grupo=""; $cod_concepto_grupo="";
      ...
      class PDF extends FPDF{
		function Header(){ global $criterio1; global $tipo_nomina_grupo; global $cod_concepto_grupo;
			...
			$this->Cell(50);
			$this->Cell(100,10,'CATALOGO DE FORMULA DE CONCEPTOS',1,0,'C');
			$this->Ln(18);
    ...
    if($tipo_rpt=="EXCEL"){ $res=pg_query($sSQL);  $tipo_nomina_grupo=""; $cod_concepto_grupo="";
	  header("Content-type: application/vnd.ms-excel");
          header("Content-Disposition: attachment; filename=Catalago_Formulas_Conceptos.xls");		
	  ?>
       <table border="0" cellspacing='0' cellpadding='0' align="left">
	     <tr height="20">
		        <td width="100" align="left" ><strong></strong></td>
                <td width="400" align="center" > <font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><strong>CATALOGO DE FORMULA DE CONCEPTOS</strong></font></td>
	      </tr>
	      <tr height="20">
	     </tr>
             <tr height="20">
