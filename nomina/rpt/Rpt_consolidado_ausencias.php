	  ...
	  ?>
	   <table border="0" cellspacing='0' cellpadding='0' align="left">
		 ...
		 <tr height="20">
		   ...
		   <td width="150" align="left"><strong>Cargo</strong></td>
		   
		   <td width="100" align="center"><strong>DIAS NO TRABAJADOS</strong></td>
		   <td width="100" align="center"><strong>ASIGN. x PERMISO REMUNERADO</strong></td>
		   <td width="100" align="center"><strong>PERMISO DE PATERNIDAD REMUNER.</strong></td>
		   <td width="100" align="center"><strong>REPOSO MEDICO CORTO</strong></td>
		   <td width="100" align="center"><strong>REPOSO MEDICO</strong></td>
		 </tr>
		...
		if(($prev_cod_empleado<>$cod_emp)or($prev_cod_cat<>$cod_cat)){ $cant_emp=$cant_emp+1;
			...
			?>
		      <tr>
                  ...
                  <td width="150" align="left"><? echo $des_cargo; ?></td>	                  
