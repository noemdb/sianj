...
include ("../../class/conect.php");
   ...
   {
         // LLAMAR A PHP_REPORT
         $sSQL = "SELECT NOM031.Cod_Empleado, NOM006.Nombre, NOM006.Cedula, NOM031.Fecha_Adelanto, NOM031.Total_Prestaciones, NOM031.Total_Adelanto, NOM031.Saldo_Prestaciones,
                  NOM031.Monto_Adelanto
                  FROM NOM006 NOM006, NOM031 NOM031
                  WHERE NOM006.Cod_Empleado = NOM031.Cod_Empleado  ORDER BY NOM031.Cod_Empleado";

            $oRpt = new PHPReportMaker();
            $oRpt->setXML("Rpt_compro_anti_presta_mpr_re.xml");
            $oRpt->setUser("$user");
