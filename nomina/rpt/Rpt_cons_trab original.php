...
$texto2="     Constancia que se expide a petición de parte interesada en ".$ciudade." a los ".$diad." días del mes de ".$mesd." del Año ".$anod;
}
...
if($error==0){ require('../../class/fpdf/fpdf.php');
	...
	$pdf->Ln(10);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(200,4,'ATENTAMENTE',0,1,'C');
	$pdf->Ln(10);
