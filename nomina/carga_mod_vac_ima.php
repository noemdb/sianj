...
if($filas>=1){  $registro=pg_fetch_array($res,0);  $nombre=$registro["nombre"]; $cedula=$registro["cedula"]; $fecha_ingreso=$registro["fecha_ingreso"];  $fecha_ingreso=formato_ddmmaaaa($fecha_ingreso);
  ...
  $monto_bono_vaca_a=$registro["monto_bono_vaca_a"]; $total_bono_vac=$monto_bono_vac+$monto_bono_vaca_a;
 ...
 $dias_bono_vac=formato_monto($dias_bono_vac); $dias_bono_vac_a=formato_monto($dias_bono_vac_a); $monto_bono_vaca_a=formato_monto($monto_bono_vaca_a);
 $dias_nohabiles=round($dias_nohabiles,0); $dias_vac=round($dias_vac,0); $total_bono_vac=formato_monto($total_bono_vac);
...
?>
<form name="form2" method="post" action="Mod_cal_vacaciones_ima.php">
<table width="10">
  <tr>
     ...
     <td width="5"><input name="txtmonto_bono_vac_a" type="hidden" id="txtmonto_bono_vac_a" value="<?echo $monto_bono_vaca_a?>"></td>	
