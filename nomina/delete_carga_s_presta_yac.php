...
$url="Act_sueldo_prestaciones_yac.php?Gcriterio=C".$fechab.$cod_empleado_d;  $cod_empleado=$cod_empleado_d;  $sfecha=formato_aaaammdd($fecha_hoy);
...
if (pg_ErrorMessage($conn)){$error=1; ?><script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script><?}
 ...
 }pg_close();  $url="Act_sueldo_prestaciones_yac.php?Gcriterio=C".$fechab.$cod_empleado;
