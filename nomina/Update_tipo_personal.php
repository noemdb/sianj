...
if (pg_ErrorMessage($conn)){$error=1; ?><script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script><?}
  ...
  if($filas==0){$error=1; ?> <script language="JavaScript"> muestra('TIPO DE PERSONAL NO EXISTE');</script><? }
  ...
  if($error==0){$sfecha=formato_aaaammdd($fecha_hoy);
    $sSQL="SELECT ACTUALIZA_NOM015(2,'$cod_tipo_personal','$des_tipo_personal','$sfecha','','$sfecha','S',0,0,'000','$fijo_cont','$emp_obr','S')";
