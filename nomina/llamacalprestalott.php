...
$m1=FDate($fechah); $m2=FDate($fecha_tope); if($m1<$m2){  echo " Fecha Calculo:".$fechah." numero:".$m1.",    Fecha desde Valida mayor a:".$fecha_tope." numero:".$m2; $error=1;?><script language="JavaScript">muestra('FECHA CALCULO DE PRESTACIONES INVALIDA');</script><? }
pg_close(); $url="Insert_calculo_presta_lott.php?codigo_d=".$cod_empleado."&codigo_h=".$cod_empleado."&tipod=".$tipo_nomina."&tipoh=".$tipo_nomina."&fechah=".$fechah;
