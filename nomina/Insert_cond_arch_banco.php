...
if (pg_ErrorMessage($conn)){$error=1; ?><script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script><?}
  ...
  if($error==0){$sSQL="SELECT ACTUALIZA_NOM057(1,'$cod_arch_banco','$tipo_arch_banco','$pos_campo','$cod_condicion','$tipo_campo','$condicion_evaluar','$svalor_evaluar','$svalor_retornar',$nvalor_evaluar,$nvalor_retornar)";
