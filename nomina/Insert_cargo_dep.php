...
if (pg_ErrorMessage($conn)){$error=1; ?><script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script><?}
  ...
  if($filas>=1){$error=1; ?> <script language="JavaScript"> muestra('CODIGO DE CARGO YA EXISTE EN EL DEPARTAMENTO');</script><? }
  ...
  if($error==0){$sfecha=formato_aaaammdd($fecha_hoy);
    $sSQL="SELECT ACTUALIZA_NOM043(1,'$codigo_departamento','$codigo_cargo','$cod_tipo_personal',$nro_cargos,$asignados)";
