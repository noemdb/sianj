...
if (pg_ErrorMessage($conn)){$error=1; ?><script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script><?}
  ...
  if($error==0){$sfecha=formato_aaaammdd($fecha_hoy);
     $sSQL="SELECT ACTUALIZA_NOM028(1,'$cod_empleado','$fechap',$monto_sueldo,$monto_sueldo_adic,$monto_base,$dias_ajuste,$monto_ajuste,0,0,0,0,0,0,'$minf_usuario','000','$fechap','','000','$fechap','')";
