...
<body>
  <table width="832" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td  width="420" align="center"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar Cuentas a la Orden" onclick="javascript:Llama_Inc_Codigos('<?echo $codigo_mov?>')"></td>
