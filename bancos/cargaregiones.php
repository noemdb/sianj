<?include ("../class/conect.php"); include ("../class/funciones.php"); if($_GET["mregion"]){$region=$_GET["mregion"];}else{$region="";}
$conn=pg_connect("host=".$host." port=".$port." password=".$password." user=".$user." dbname=".$dbname."");
$StrSQL="select * from PRE092 order by cod_region";  $res=pg_query($StrSQL);
?><select name="txtregion" id="txtregion" onFocus="encender(this)" onBlur="apagar(this)"  onKeypress="return stabular(event,this)">  <?
