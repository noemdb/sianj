...
function Llama_Inc_Codigos(mcodigo_mov,dcmov){var mmonto; var mdebe; var mhaber;
  ...
  LlamarURL('Inc_cuenta_lib.php?codigo_mov=<?echo $codigo_mov?>&password=<?echo $password?>&user=<?echo $user?>&dbname=<?echo $dbname?>&monto='+mmonto+'&dcmov='+dcmov);
}
...
<body>
  <table width="832" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td  width="420" align="center"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar Cuentas a la Orden" onclick="javascript:Llama_Inc_Codigos('<?echo $codigo_mov?>','<?echo $dcmov?>')"></td>
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:Llama_Modificar('<? echo $codigo_mov; ?>','<? echo $registro["cod_cuenta"]; ?>','<? echo $registro["debito_credito"]; ?>','<?echo $dcmov; ?>');">
