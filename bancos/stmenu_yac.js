...
var tmenuItems = [
    ["Archivo","", "", "", "", "Menu Archivos", "", "0", "", "", ],
        ...
        ["|Grupo Flujo de Caja","Act_Grupo_Pre_Caja.php", "", "", "", "", "", "", "", "", ],
		["|Titulo Flujo de Caja","Act_Titulo_Pre_Caja.php", "", "", "", "", "", "", "", "", ],
		["|Definir Flujo de Caja","Act_Flujo_Caja.php", "", "", "", "", "", "", "", "", ],
    ...
    ["Procesos","", "", "", "", "Menu Procesos", "", "0", "", "", ],        
		...
		["|Notas de Debito","", "", "", "", "", "", "0", "", "", ],
			...
			["||Notas Debito Orden Nomina","Emision_Ndb_ord_nomina_yac.php?continua=N", "", "", "", "", "", "", "", "", ],
		["|Movimientos","", "", "", "", "", "", "0", "", "", ],
		...
		["|Movimientos Ctas. Dolares","", "", "", "", "", "", "0", "", "", ],
		    ["||Definicion Cuentas Dolares","Act_cuentas_dolares.php", "", "", "", "", "", "", "", "", ],
		    ["||Definicion Bancos Dolares","Act_bancos_dolares.php", "", "", "", "", "", "", "", "", ],
			//["||Tasa de Cambio Dolares","Act_tasa_cambio.php", "", "", "", "", "", "", "", "", ],
		    ["||Movimientos Cuentas Dolares","Act_Mov_cta_dolares.php", "", "", "", "", "", "", "", "", ],			
	    ...
	    ["|Clasificacion Gastos para Flujo","Act_Gasto_flujo.php", "", "", "", "", "", "", "", "", ],
		["|Generar Flujo de Caja","Act_Gen_Flujo_Caja.php", "", "", "", "", "", "", "", "", ],
...
//            ["||Ruta de Cheques","/sia/bancos/rpt/Rpt_Ruta_Cheques.php", "", "", "", "", "", "", "", "", ],
            ["||Balance de Caja","/sia/bancos/rpt/Rpt_Balance_caja.php", "", "", "", "", "", "", "", "", ],
			["||Presupuesto de Caja","/sia/bancos/rpt/Rpt_Presupuesto_Caja.php", "", "", "", "", "", "", "", "", ],
			["||Verifica Gasto de Flujo","/sia/bancos/rpt/Rpt_Verifica_gasto_flujo.php", "", "", "", "", "", "", "", "", ],
			
			["||Comparacion Presupuestaria Flujo de Caja","/sia/bancos/rpt/Rpt_Comparacion_presup_flujo.php", "", "", "", "", "", "", "", "", ],
 			["||Depositos Bancarios","/sia/bancos/rpt/Rpt_Dep_Bancarios.php", "", "", "", "", "", "", "", "", ],
			["||Archivo Excel Verifica Flujo de Caja","/sia/bancos/rpt/Rpt_Verifica_flujo_caja.php", "", "", "", "", "", "", "", "", ],
		 ["|Movimientos en Dolares","", "", "", "", "", "", "0", "", "", ],
            ["||Movimientos por Cuentas","/sia/bancos/rpt/Rpt_Movimientos_Dolares.php", "", "", "", "", "", "", "", "", ],	
			["||Prsupuesto de Caja en Dolares","", "", "", "", "", "", "", "", "", ],	
