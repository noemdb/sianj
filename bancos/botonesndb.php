...
<table width="957"> <tr><td><table width="923"> <td width="329"><input name="txtcodigo_mov" type="hidden" id="txtcodigo_mov" value="<?echo $codigo_mov?>"></td> <td width="100"><input name="txtconcepto" type="hidden" id="txtconcepto" value=""></td>
