...
$cod_ret="00"; $nro_deposito=""; $nom_banco=""; $fecha_ent=asigna_fecha_hoy();
...
if (pg_ErrorMessage($conn)) { ?> <script language="JavaScript">   muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');  </script> <?}
  ...
  if($error==0){ $sfechaf=formato_aaaammdd($fecha_ent);  
    ...
    else{ $sSQL="SELECT ACTUALIZA_BAN013(3,'$tipo_planilla','$nro_planilla','$cod_ret','$sfechaf','$nom_banco','$nro_deposito','','')";
