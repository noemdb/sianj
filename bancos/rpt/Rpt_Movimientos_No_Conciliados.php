...
<html>
<head>
<title>SIA CONTROL BANCARIO (Reporte Movimientos no Conciliados)</title>
        ...
        <tr>
          <td height="19"><table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="174" align="left"><span class="Estilo5"><input class="Estilo10" name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $fecha_d?>" size="12" maxlength="10" onChange="checkrefechad(this.form)">
              ...
              <td width="244" align="left"><span class="Estilo5"><input class="Estilo10" name="txtFechah" type="text" id="txtFechah" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $fecha_h?>" size="12" maxlength="10" onChange="checkrefechah(this.form)">
