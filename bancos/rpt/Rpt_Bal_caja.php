   ...
   if($tipo_rep=="PDF"){	
      ...
      class PDF extends FPDF{ 
		function Header(){ global $criterio1;
			...
			$this->Cell(30);
			$this->Cell(150,10,'BALANCE DE CAJA',1,0,'C');
			$this->Ln(10);
			$this->SetFont('Arial','B',9);
			$this->Cell(200,10,$criterio1,0,1,'C');	
			$this->SetFont('Arial','B',8);
			$this->Cell(5,5,'','LTB',0);
			$this->Cell(130,5,'NOMBRE BANCO','TB',0);
			$this->Cell(40,5,'NRO DE CUENTA',1,0,'L');
	  ...
	  while($registro=pg_fetch_array($res)){ $i=$i+1;
		   ...
		   $pdf->SetXY($x+$n,$y);		   
		   $pdf->Cell(40,5,$nro_cuenta,0,0,'L'); 
		   $pdf->Cell(25,5,$saldo_act,0,1,'R');
		   $pdf->SetXY($x,$y);
		...
		$pdf->Cell(175,2,'',0,0);
		$pdf->Cell(25,2,'==============',0,1,'R');
		$pdf->Cell(175,4,'TOTAL BALANCE DE CAJA : ',0,0,'R');
