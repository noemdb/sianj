        ...
        <tr>
          <td height="19"><table width="775" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="610"><span class="Estilo5"><input class="Estilo10" name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $fecha_d?>" size="12" maxlength="10"  class="Estilo5" onChange="checkrefechad(this.form)" onkeyup="mascara(this,'/',patronfecha,true)">
              ...
              <td width="5"><input class="Estilo10" name="txtcod_banco_d" type="hidden" id="txtcod_banco_d" value="<?echo $cod_banco_d?>" ></td>
              <td width="5"><input class="Estilo10" name="txtcod_banco_h" type="hidden" id="txtcod_banco_h" value="<?echo $cod_banco_h?>" ></td>
            </tr>
          </table></td>
        </tr>
        <tr> <td height="19">&nbsp;</td>   </tr>
