...
<html>
<head>
<title>SIA CONTROL BANCARIO (Reporte Relaci&oacute;n Cheques / Ordenes de Pago)</title>
        ...
        <tr>
          <td height="19"><table width="783" border="0">
            <tr>
              ...
              <td width="249"><span class="Estilo5"> <input class="Estilo10" name="txtnumordend" type="text" id="txtnumordend" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $num_orden_d?>" size="12" maxlength="12">  </span></td>
              <td width="92"><span class="Estilo5">HASTA :</span></td>
              <td width="220"><span class="Estilo5"><input class="Estilo10" name="txtnumordenh" type="text" id="txtnumordenh" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $num_orden_h?>" size="12" maxlength="12"></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
