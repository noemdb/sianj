...
$nombre_banco="";$nro_cuenta="";$concepto="";$num_cheque=""; $nro_orden=""; $nro_ordenp=""; $nombre_benef=""; $ced_rif=""; $concepto=""; $monto_cheque=0; $fecha=""; $mes=""; $inf_usuario=""; $anulado="N";  $fecha_anulado="";  $tipo_pago=""; $edo_cheque=""; $entregado="N";$fecha_entregado="";$ced_rif_recib="";$nombre_recib="";
$musuario_sia=""; $mnombre_usuario_sia=""; $res=pg_query($sql);$filas=pg_num_rows($res);
if($filas>=1){$registro=pg_fetch_array($res,0);
  $cod_banco=$registro["cod_banco"]; $nombre_banco=$registro["nombre_banco"]; $nro_cuenta=$registro["nro_cuenta"]; $anulado=$registro["anulado"];  $fecha_anulado=$registro["fecha_anulado"]; $tipo_pago=$registro["tipo_pago"]; $nro_ordenp=$registro["nro_orden_pago"];
...
class PDF extends FPDF{ 
	function Header(){global $monto_cheque; global $nombre_benef; global $monto_letras; global $lugar; global $ano; global $nombre_banco; 
	   global $concepto; global $nro_cuenta; global $num_cheque; global $fecha; global $nro_orden;  global $tipo_causado; global $nro_ordenp; global $fechaop; 
        //$this->AddFont('Arial','','lucon.php');		
		$this->SetFont('Arial','',11);
		//$this->Cell(200,4,'',0,1,'L');
		//$this->Line(5);
		$this->Cell(200,20,'   ',0,1,'L');
		...
		$this->Cell(120,4,'',0,0,'L');
		$this->Cell(50,4,'CADUCA A LOS 90 DIAS',0,0,'C');
		...
		$this->Cell(50,6,$tipo_causado,0,0,'L');
		$this->Cell(20,6,$nro_ordenp,0,0,'L');
		$this->Cell(40,6,$fechaop,0,1,'L');
		...
		$this->Cell(30,6,'',0,0,'L');
		$this->Cell(90,6,$nombre_banco,0,0,'L');
		$this->Cell(40,6,$num_cheque,0,1,'L');
		
		$this->Cell(80,6,$nro_cuenta,0,0,'L');
		$this->Cell(20,6,'',0,0,'L');
		$this->Cell(40,6,$fecha,0,1,'L');
		
		
		$this->Cell(30,6,'',0,0,'L');
		
		$this->Cell(170,6,$nombre_benef,0,1,'L');
  ...
  $pdf->SetFont('Arial','',10);
  $pdf->Cell(10,4,'',0,0,'L');
  //$pdf->Cell(170,3,"O/P. ".$nro_orden,0,1,'L');
