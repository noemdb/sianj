...
<html>
<head>
<title>SIA CONTROL BANCARIO (Reporte Listado Beneficiario)</title>
        ...
        <tr>
          <td height="19" colspan="3" align="center"  ><table width="784" border="0">
            <tr>
              ...
              <td width="99"><span class="Estilo5"> <input class="Estilo10" name="txtcedula_d" type="text" id="txtcedula_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $cedula_d?>" size="15" maxlength="15">
              </span></td>
              <td width="118"><span class="Estilo5"><input class="Estilo10" name="catcedd" type="button" id="catcedd" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosd.php?criterio=','SIA','','750','500','true')" value="...">
              </span></td>
              <td width="102"><span class="Estilo5"><input class="Estilo10" name="txtcedula_h" type="text" id="txtcedula_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $cedula_h?>" size="15" maxlength="15">
              </span></td>
              <td width="253"><span class="Estilo5"><input class="Estilo10" name="catcedh" type="button" id="catcedh" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosh.php?criterio=','SIA','','750','500','true')" value="...">
              </span></td>
            </tr>
          </table></td>
        </tr>
