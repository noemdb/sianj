...
<html>
<head>
<title>SIA CONTROL BANCARIO (Reporte Movimientos en Bancos)</title>
        ...
        <tr>
          <td height="30"><table width="776" border="0">
            <tr>
              ...
              <td width="427"><span class="Estilo5"><input class="Estilo10" name="txtdesc_banco_d" type="text" id="txtcod_titulo22" size="60" maxlength="150"  value="<?echo $nombre_banco_d?>" readonly>   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
