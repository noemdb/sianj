...
<html>
<head>
<title>SIA CONTROL BANCARIO (Reporte Cheques Caducados por Bancos)</title>
          ...
          <td height="22"><table width="790" border="0" >
            <tr>
              ...
              <td width="245" align="center"><div align="left"><span class="Estilo5">
                  <input class="Estilo10" name="txtfechaanud" type="text" id="txtfechaanud" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $fecha_cadu_d?>" size="12" maxlength="10" onChange="checkrefechad(this.form)">
              ...
              <td width="228" align="center"><div align="left"><span class="Estilo5">
                  <input class="Estilo10" name="txtfechaanuh" type="text" id="txtfechaanuh" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $fecha_cadu_h?>" size="12" maxlength="10" onChange="checkrefechah(this.form)">
          ...
          <td height="19"><table width="830" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
			  ...
			  <td width="160" align="right"><span class="Estilo5">FECHA DE PROCESO : </span></td>
			   <td width="210" align="center"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txtFecha" type="text" id="txtFecha" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $fecha_hoy?>" size="12" maxlength="10" onChange="checkrefechah(this.form)">
                  <img src="../../imagenes/img_cal.png" width="20" height="14" id="calendario7" style="cursor: pointer; border: 1px solid blue;" title="Seleccionar Fecha"
