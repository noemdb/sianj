        ...
        <tr>
          <td height="19"><table width="783" border="0">
            <tr>
              ...
              <td width="198"><span class="Estilo5"><input class="Estilo10" name="txtreferencia_d" type="text" id="txtreferencia_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $referencia_d?>" size="8" maxlength="8"> </span></td>
              <td width="110"><span class="Estilo5">HASTA :</span></td>
              <td width="253"><span class="Estilo5"> <input class="Estilo10" name="txtreferencia_h" type="text" id="txtreferencia_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $referencia_h?>" size="8" maxlength="8"> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
