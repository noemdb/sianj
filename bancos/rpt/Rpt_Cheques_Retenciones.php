...
<html>
<head>
<title>SIA CONTROL BANCARIO (Reporte Cheques/Retenciones)</title>
        ...
        <tr>
          <td height="19" colspan="2"><table width="776" border="0">
            <tr>
              ...
              <td width="56"><span class="Estilo5"><input name="txtcod_banco_d" type="text" id="txtcod_banco_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $cod_banco_d?>" size="5" maxlength="5">              </span></td>
              <td width="47"><span class="Estilo5"><input name="Cat_codd" type="button" id="Cat_codd" title="Abrir Catalogo de Cuentas" onClick="VentanaCentrada('../Cat_Bancosd.php?criterio=','SIA','','750','500','true')" value="...">              </span></td>
              <td width="450"><span class="Estilo5"><input name="txtdesc_banco_d" type="text" id="txtdesc_banco_d" size="70" maxlength="70" value="<?echo $nombre_banco_d?>"  readonly>          </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="19" colspan="2"><table width="776" border="0">
            <tr>
              ...
              <td width="55"><span class="Estilo5"><input name="txtcod_banco_h" type="text" id="txtcod_banco_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $cod_banco_h?>" size="5" maxlength="5">              </span></td>
              <td width="46"><span class="Estilo5"> <input name="Cat_codh" type="button" id="Cat_codh" title="Abrir Catalogo de Cuentas" onClick="VentanaCentrada('../Cat_Bancosh.php?criterio=','SIA','','750','500','true')" value="...">              </span></td>
              <td width="450"><span class="Estilo5"><input name="txtdesc_banco_h" type="text" id="txtdesc_banco_h" size="70" maxlength="70" value="<?echo $nombre_banco_h?>" readonly>              </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="19" colspan="2"><table width="783" border="0">
            <tr>
              ...
              <td width="249"><span class="Estilo5"><input name="txtnum_cheque_d" type="text" id="txtnum_cheque_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $num_cheque_d?>" size="12" maxlength="8">  </span></td>
              <td width="92"align="left" ><span class="Estilo5">HASTA :</span> </td>
              <td width="220"><span class="Estilo5"><input name="txtnum_cheque_h" type="text" id="txtnum_cheque_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $num_cheque_h?>" size="12" maxlength="8">   </span></td>
            </tr>
          </table></td>
        </tr>   
		 <tr>
        ...
        <tr>
          <td height="19" colspan="2"><table width="833" border="0">
            <tr>
              ...
              <td width="444"><span class="Estilo5"><input name="txtdesccedrifbenefd" type="text" id="txtdesccedrifbenefd" size="70" maxlength="70"  value="<?echo $nombre_d?>" readonly>    </span></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="19" colspan="2"><table width="834" border="0">
            <tr>
              ...
              <td width="442"><span class="Estilo5"><input name="txtdesccedrifbenefh" type="text" id="txtdesccedrifbenefh" size="70" maxlength="70" value="<?echo $nombre_h?>"  readonly>  </span></span></td>
            </tr>
          </table></td>
        </tr>
