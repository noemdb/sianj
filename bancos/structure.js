...
//		animation:0,
	...
	sub:[
		...
		sub:[
			...
			{html:'Grupo de Bancos', url:'Act_Grupos_Banco.php'},
			{html:'Grupo Flujo de Caja', url:'Act_Grupo_Pre_Caja.php'},
			{html:'Titulo Flujo de Caja', url:'Act_Titulo_Pre_Caja.php'},
			{html:'Definir Flujo de Caja', url:'Act_Flujo_Caja.php'},
			{html:'Tipo Planillas de Retención', url:'Act_Tipo_Planillas.php'},
			{html:'Tipo de Enrriquecimiento', url:'Act_tipo_enriquecimiento.php'},
		...
		sub:[
			...
			sub:[
			    {html:'Cheques a Orden', url:'Act_Emision_Cheque.php'},
			    {html:'Cheques a Beneficiario Especifico', url:'Act_Emision_Cheque_Ret.php'},
			    {html:'Cheques Financiero', url:'Act_Emision_Cheque_No.php'},
			    {html:'Cheques a Años Anteriores', url:'Act_Emision_Cheque_Ant.php'},
			    ]
		     },
		     {html:'Notas de Débito', 
			 sub:[
			     {html:'Notas Débito a Orden', url:'Act_Emision_Ndb_Ant.php'},
			     {html:'Nota Débito Directa', url:'Act_Emision_Ndb_Dir.php'},
			     {html:'Nota Débito Anos Anteriores', url:'Act_Emision_Ndb_Ant.php'},
			     ]
		     }, 
			 {html:'Movimientos', 
			 sub:[
			...
			{html:'Conciliación Bancaria', url:'Act_Conciliacion.php'}, 
			{html:'Colocaciones Bancaria', url:'Act_Colocaciones.php'},
			{html:'Estado de Cheques', url:'Act_Edo_Cheques.php'},
			{html:'Generar Planillas de Retención', url:'Act_Gen_Planilla_Ret.php'},
			{html:'Actualizar Impuesto Enterado', 
			sub:[
			    {html:'Por Benficiario', url:'Act_Imp_Por_Beneficiario.php'},
			    {html:'Por Planillas', url:'Act_Imp_Por_Planilla.php'},
			    ]
		     },
			 {html:'Comprobante de Retención IVA', url:'Act_Comprobante_Ret_IVA.php'},
			 {html:'Declaración de Retención IVA', url:'Act_Declaracion_Ret_IVA.php'},
			 {html:'Generar Flujo de Caja', url:'Act_Generar_flujo_Caja.php'},
		    ] 
		},
		{html:'Reportes', 
		sub:[
		    ...
		    sub:[
			    {html:'Ordenes de Pago', url:'/sia/bancos/rpt/Rpt_Relacion_Cheque_Ord_Pago.php'},
			    {html:'Notas de Débito', url:'/sia/bancos/rpt/Rpt_Relacion_Nota_Deb_Ord_Pago.php'}
				]
		    },
			{html:'Relación por Cod. Presupuestarios', 
		    sub:[
			    {html:'Cheques/Cod. Presupuestarios', url:'/sia/bancos/rpt/Rpt_Relacion_Cheque_Cod_Presup.php'},
			    {html:'Notas de Débito/Cod. Presupuestarios', url:'/sia/bancos/rpt/Rpt_Relacion_Nota_Deb_Cod_Presup.php'}
				]
		    },
		    ...
		    sub:[
			    ...
			    {html:'Liustado Planillas de Retención/Beneficiario', url:'/sia/bancos/rpt/Rpt_Listado_Planillas_Retencion_Beneficiario.php'},
				...
				{html:'Listado de Retencion de IVA', url:'/sia/bancos/rpt/Rpt_Listado_Retencion_IVA.php'},
				{html:'Listado de Retencion de IVA por Beneficiario', url:'/sia/bancos/rpt/Rpt_Listado_Ret_IVA_Beneficiario.php'},
				]
		    },
		    ...
		    sub:[
				...
				{html:'Relacion Gastos Presupuestarios', url:'/sia/bancos/rpt/Rpt_Relacion_Gastos_Presupuestarios.php'},
				]
		    },
			]
		},
